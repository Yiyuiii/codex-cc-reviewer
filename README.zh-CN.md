...
| `includeUntrackedContent` | `review_diff` 和 `adversarial_review` 默认开启 | 在 diff 类 packet 中包含精选 untracked 文本正文。 | 新的本地文本文件可能被发送给 Claude Code。 | 只想列出 untracked 路径时设为 `false`。 |
